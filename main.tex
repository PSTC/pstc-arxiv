\pdfoutput=1
\documentclass[acmsmall,screen,anonymous,review,10pt]{acmart} % anonymous, review
...
\input{inserts/pre.tex}

\begin{document}

\input{inserts/abstract.tex}
...
\input{figures/algorithm-cont.tex}
